...
public class TbOrder implements Serializable{
    ...
    /** 在线支付 */
    private static final String PAYMENTTYPE_ONLINE = "1";
    /** 货到付款 */
    private static final String PAYMENTTYPE_ARRIVAL = "2";

    /** '状态：1、未付款，2、已付款，3、未发货，4、已发货，5、交易成功，6、交易关闭,7、待评价' */
    public static final String STATUS_NOT_PAY = "1";
    public static final String STATUS_PAY = "2";
    public static final String STATUS_NO_SHIP = "3";
    public static final String STATUS_SHIP = "4";
    public static final String STATUS_OK = "5";
    public static final String STATUS_CLOSE = "6";
    public static final String STATUS_WAIT_APPRAISE = "7";
