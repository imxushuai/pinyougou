...
public class TbGoods implements Serializable{
    ...
    /** 审核通过 */
    public static String STATUS_CHECK = "1";
    /** 审核未通过 */
    public static String STATUS_CHECK_NOT_PASS = "2";
    /** 已关闭 */
    public static String STATUS_CLOSE = "3";

    /** 启用规格 */
    public static String ISENABLESPEC_YES = "1";
    /** 未启用规格 */
    public static String ISENABLESPEC_NO = "0";
