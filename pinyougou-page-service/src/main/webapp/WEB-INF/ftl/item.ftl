                            ...
                            <#list specList as spec>
                                <dl>
                                    ...
                                    <#list spec.attributeValue as attrValue>
                                        <dd>
                                            <a href="javascript:void(0)" class="{{isSelected('${spec.attributeName}','${attrValue}') ? 'selected' : ''}}"
                                                   ng-click="selectSpec('${spec.attributeName}','${attrValue}')">
                                                    ${attrValue}<span title="点击取消选择">&nbsp;</span>
                                            </a>
                                        </dd>
                        ...
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    ...
                                    <a href="javascript:void(0)" ng-click="incrNum()" class="increment plus">+</a>
                                    <a href="javascript:void(0)" ng-click="decrNum()" class="increment mins">-</a>
                                </div>
                            </div>
                        </div>
                        <div class="fl">
